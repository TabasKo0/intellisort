...
export default function SignUpPage() {
  ...
  return (
    <div className="waste-sort-container relative overflow-hidden min-h-screen flex items-center justify-center p-6">
      {/* Ambient orbs */}
      <div aria-hidden="true" className="pointer-events-none absolute h-80 w-80 rounded-full bg-emerald-500/15 blur-3xl top-[-5rem] right-[-5rem]" />
      <div aria-hidden="true" className="pointer-events-none absolute h-64 w-64 rounded-full bg-teal-400/10 blur-3xl bottom-[-4rem] left-[-4rem]" />
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-scale">
        <div className="glass-card p-8 shadow-2xl space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            <div>
              <h1 className="text-3xl font-extrabold gradient-text">Join IntelliSort</h1>
              <p className="text-sm text-muted-foreground mt-1">Create an account to start sorting waste sustainably</p>
            </div>
          </div>
